export const iccsData = [
    ...
    },
    {
        ...
        <ol>
        <li>1.Secure PLC Programming</li>
            <ul>
            <li>•Top 20 Secure PLC Coding Practices</li>
            <li>•Top 20 Secure PLC Coding Break-down and Lessons Learned by Sarah Fluchs</li>
            </ul>
        <li>2.PLC Security Top 20 List was started by a global community that developed a set of guidelines for leading practices for secure PLC programming. On the website, the PDF is free to download, and videos exist that instruct the viewer on how to implement the individual secure practices.</li>
        <li>3.Defense in Depth</li>
            <ul>
        ...
        <ol>
        <li>1.NIST 800-128 Guide for Security-Focused Configuration Management of Information Systems</li>
        <li>2.NSA Network Infrastructure Security Guide June 2022: https://media.defense.gov/2022/Jun/15/2003018261/-1/-1/0/CTR_NSA_NETWORK_INFRASTRUCTURE_SECURITY_GUIDE_20220615.PDF</li>
        </ol>
    ...
    },
    {
        ...
        ot: [
        {
            ...
            untagged: ["•Bitwarden", "•LastPass", "•Password-Protected Excel Sheet"]
        },
        {
            id: 2,
            header: "Authentication / Account Management",
            untagged: ["Windows", "•Active Directory", "•Azure Active Directory", "Linux", "•Active Directory", "•FreeIPA", "HMI/PLC", "•Active Directory (for supported HMIs)", "•Rockwell FactoryTalk Security", "•Siemens TIA Portal"],
            writeup: "There are other vendor-specific products (Industrial Automation Software) to configure security, including account management. Here Rockwell and Siemens are highlighted given they are market share leaders for Industrial Automation."
            }
    ],
        practices: `<!DOCTYPE html><html><body>
        ...
        <ol>
        <li>1.Establish an inventory of accounts and disable dormant accounts.</li>
        <li>2.Each account should have a unique and complex password with only the privileges needed to perform job duties.</li>
        <li>3.In the condition that centralized account management is possible, use a directory or identity service for accounts (e.g., Active Directory).</li>
        <li>4.Establish and maintain an inventory of service accounts.</li>
        </ol>
        ...
        <ol>
        <li>1.A “daily driver” lower privilege user account should be used for day-to-day tasks where admin account credentials are prompted when system changes occur.</li>
            <ul>
            <li>•Listed as one of the SL1 requirements from the ISA 62443 4-2 standard</li>
            </ul>
        <li>2.Limit who and where administrator accounts exist.</li>
            <ul>
        ...
        <li>3.Separate and Secure Credentials.</li>
            <ul>
            <li>•Administrator accounts have additional emphasis.</li>
            </ul>
        <li>4.Password Manager.</li>
            <ul>
        ...
        <ol>
        <li>1.Membership to the Enterprise Admins group must be restricted to accounts used only to manage the Active Directory Forest.</li>
        <li>2.Membership to the Domain Admins group must be restricted to accounts used only to manage the Active Directory domain and domain controllers.</li>
        <li>3.Delegation of privileged accounts must be prohibited.</li>
        <li>4.Local administrator accounts on domain systems must not share the same password.</li>
        <li>5.Domain controllers must be blocked from Internet access.</li>
        <li>6.Usage of administrative accounts must be monitored for suspicious and anomalous activity.</li>
        </ol>
        ...
        <ol>
        <li>1.Local user accounts/groups/permissions</li>
        <li>2.Windows-linked user accounts/groups through Active Directory</li>
        </ol>
    ...
    },
    {
        ...
        },
        {
            ...
            untagged: ["•Active Directory", "•Azure Active Directory"]
            }
    ],
        practices: `<!DOCTYPE html><html><body>
        ...
        <p>In terms of meeting this CIS Control, an organization should do the following:</p>
        <ol>
        <li>1. Establish an Access Granting and Revoking Process.</li>
        <li>2. Centralize Access Control through an SSO/MFA provider.</li>
        <li>3. Require MFA for External, Network, and Admin access minimally.</li>
        <li>4. Maintain Role-Based Access Control.</li>
        </ol>
        ...
        <ol>
        <li>1. Implement for all users, including contractors and remote users.</li>
        <li>2. Use strong authentication methods such as mobile app auth instead of SMS.</li>
        <li>3. Secure MFA configuration. Limit who can configure MFA to prevent unauthorized changes.</li>
        </ol>
    ...
    },
    {
        ...
        <ol>
        <li>1. What solution will be used to conduct vulnerability scanning</li>
        <li>2. What systems/applications will be scanned</li>
        <li>3. How often will the scanning occur</li>
        <li>4. Who will do the scanning</li>
        <li>5. Can the scanning be automated</li>
        <li>6. Do regulations applicable to the organization require vulnerability scanning</li>
        <li>7. Upon analyzing the results how do we organize, prioritize, and remediate detected vulnerabilities</li>
        </ol>
        <p><strong>So what does Vulnerability Management look like?</strong></p>
        <ol>
        <li>1. Start with knowing your assets / resources. Typically a monthly scan makes sense.</li>
        <li>2. Start addressing the top risk assets. This isn't necessarily aligned to which asset has the highest CVSS score, but what assets present the most risk to the organization. Furthermore, even once you narrow these assets down, still don't just look at the CVSS score. Determine which exploits or CVEs are actually "weaponized" or exploitable. You can use something like CISA's known vulnerability list. Tools like Qualys provide this as a widget.</li>
        <li>3. Discuss with the asset owner on what vulnerabilities can be mitigated.</li>
        <li>4. Something either gets done or it doesn't. Negotiate and plan to mitigate over a maintenance period.</li>
        <li>5. Repeat</li>
        </ol>
        ...
        <ol>
        <li>1. The importance of the asset the organization is trying to protect</li>
        <li>2. Does the asset hold any sensitive information</li>
        <li>3. Is this a vulnerability or real risk? How is this risk weighed</li>
        <li>4. Are these exploits weaponized and actively used to target</li>
        </ol>
    ...
    },
    {
        ...
        <ol>
        <li>1. What systems are capable of logging and how is this configured</li>
        <li>2. Where will the syslog/SIEM server sit in the environment</li>
        <li>3. Who or how do we review the logs</li>
        <li>4. How long will we retain audit logs</li>
        <li>5. Are there regulations that require a certain retaining period</li>
        </ol>
        ...
        <li>2. Helps to prevent an attack</li>
            <ul>
    ...
    },
    {
        ...
        <ol>
        <li>1. Allow-listing only fully supported browsers and email clients</li>
            <ul>
            <li>•Most often Chrome or Edge</li>
            </ul>
        <li>2. Keep the browsers and email clients up-to-date</li>
        <li>3. Restrict Unnecessary or unauthorized browser and email client extensions</li>
            <ul>
            <li>•This can be pushed in GPO's (Group Policy Objects) by Active Directory.</li>
            </ul>
        <li>4. Ensure cybersecurity training covers email/web best practices and acceptable use</li>
        </ol>
        ...
        <img src='/blog/web-protection.png' alt="iccs" />
        ...
        <ol>
        <li>1. Envelope From Spoofing</li>
        <li>2. Header From Spoofing</li>
        <li>3. Display Name Spoofing</li>
        </ol>
        <p><strong>3 Main Email Spoofing Solutions:</strong></p>
        <ol>
        <li>1. Sender Policy Framework (SPF) - RFC 7208</li>
        <li>2. DomainKeys Identified Mail (DKIM) - RFC 6376</li>
        <li>3. Domain Message Authentication Reporting & Conformance (DMARC) - RFC 7489</li>
        </ol>

        <p><strong>Email Spoofing Mitigation</strong></p>
        <ol>
        <li>1. Envelope from spoofing: SPF</li>
        <li>2. Header from spoofing: SPF + DMARC + DKIN</li>
        <li>3. Display name spoofing: Advanced threat filter, transport rules, and user training</li>
        <li>4. Compromised mailboxes or “legitimate” senders: Advanced threat filters, transport rules, and user training</li>
        </ol>
    ...
    },
    {
        ...
        <ol>
        <li>1. What systems/applications should be backed up (risk prioritize assets)</li>
        <li>2. Where will these backups be stored (if stored online or on the network, the storage should be properly segmented)</li>
        <li>3. How often will the backups occur</li>
        <li>4. Will we automate the backups</li>
        <li>5. How long will we keep the backups based upon regulation or storage capacity</li>
        <li>6. Who has access to the backups</li>
        <li>7. What backups will we encrypt</li>
        <li>8. In the event of a cyber attack, is operations aware of how to recover from the backups</li>
        </ol>
    ...
    },
    {
        ...
        ot: [
        {
            ...
            untagged: ["•Draw.io", "•Microsoft Visio"]
        },
        {
            id: 2,
        ...
        <img src="/blog/network-management.png" alt="network" />


        <p>When building a secure architecture, critical infrastructure organizations should reference the following documents.</p>
        <ol>
        <li>1. NIST 800-82 version 2</li>
        <li>2. On page 5-8 through 5-12 you’ll see the 4 architectures mentioned, with 5-12 being the most mature.</li>
            <ul>
        ...
        <ol>
        <li>1. Search “Network Infrastructure Security Guide June 2022”</li>
            <ul>
    ...
    },
    {
        ...
        },
        {
            id: 3,
            header: "IPS/IDS",
            writeup: "All Nextgen firewalls offer in-line IPS. All tools mentioned on the first CIS Control (Inventory) are OT IDS solutions. Omicron (substation IDS)",
    ...
    },
    {
        ...
        <ol>
        <li>1. Identification of 3rd parties</li>
        <li>2. Data classification and volume</li>
        <li>3. Availability requirements</li>
        <li>4. Cybersecurity requirements</li>
        <li>5. Applicable regulations</li>
        <li>6. Inherent risk vs mitigated risk</li>
        </ol>

        <p><strong>3rd Party Management</strong></p>
        <ol>
        <li>1. First, as always, risk assess any 3rd party access to identify if it's needed. Can you reduce the risk all together by getting rid of the access? Is it critical or needed? I.E. can the vendor come on-site instead?</li>
        <li>2. Draft your policies/standards for 3rd party access/management</li>
        <li>3. Create a list of questions for your vendors based on that.</li>
        <li>4. Include additional assurance controls such as background checks, SOC 2, ISA27001.</li>
        <li>5. Have a side channel with legal for reviewing security terms in contracts.</li>
        </ol>
    ...
    },
    {
        ...
        },
        {
            ...
            untagged: ["•Acunetix", "•Detectify", "•Fortify", "•Netsparker"]
        },
        {
            id: 5,
            header: "Interactive Application Security Testing (ISAT)",
            untagged: ["•Acunetix", "•Checkmarx", "•Data Theorem", "•Fortify"]
        }
    ],
        practices: `<!DOCTYPE html><html><body>
        ...
        <ol>
        <li>1. Create and Manage a Vulnerability Response Process</li>
        <li>2. Perform Root Cause Analysis</li>
            <ul>
        ...
        <li>3. Secure Third-Party Code</li>
            <ul>
    ...
    },
    {
        ...
        ot: [
        {
            ...
            untagged: ["•Microsoft Word", "•PagerDuty", "•Jira"]
        }
    ],
        practices: `<!DOCTYPE html><html><body>
        ...
        <ol>
        <li>1. Organizations depending on requirements should look to have yearly penetration testing assessment completed</li>
        <li>2. Remediate the findings prioritizing the highest risk first</li>
        <li>3. Validate security measures after each penetration test</li>
        <li>4. Create a penetration testing program that includes policies/procedures to ensure this process is owned by someone internally; expectations, requirements, and previous results are documented</li>
        </ol>
    ...
    },
    {
        ...
        },
        {
            ...
            untagged: ["•1898 & Co", "•Blackhills", "•Coal Fire", "•SpectorOps"]
        },
    ],
        practices: `<!DOCTYPE html><html><body>
        ...
        <ol>
        <li>1. Designate personnel to manage incident handling</li>
        <li>2. Establish and maintain contact information for reporting security incidents</li>
        <li>3. Establish and maintain an enterprise process for reporting incidents</li>
        <li>4. Establish and maintain an incident response process</li>
        <li>5. Assign key roles and responsibilities</li>
        <li>6. Define mechanisms for communicating during incident response</li>
        <li>7. Conduct routine incident response exercises or table-top-exercises</li>
        <li>8. Conduct post-incident reviews</li>
        <li>9. Establish and maintain security incident thresholds</li>
        <li>10. Build incident response policies/procedures that cover these items</li>
        </ol>

        <p><strong>Incident Response Must Haves:</strong></p>
        <ol>
        <li>1. Define Severity Tiers</li>
        <li>2. Every security incident needs to be categorized and given a level of severity. This aids in assigning service-level agreements, directing incident escalations, and alerting stakeholders to the possible or actual effects of an incident on the company. Which playbook to convey, who gets notified, and the escalation path are all determined by the severity.</li>
        <li>3. Assign Roles and Responsibilities</li>
        <li>4. Reacting to incidents effectively is a team sport. Keep a RACI chart that lists every job and responsibility for incident response inside the company. Include the C-suite, legal, privacy, and HR departments as common stakeholders.</li>
        <li>5. Develop Detailed Response Playbooks</li>
        <li>6. The CSIR team should develop specific playbooks for common or high-impact incident types — such as ransomware, as shown in this example. Response playbooks are intended to offer comprehensive instructions and processes that extend beyond the typical incident response plan of security.</li>
        <li>7. Conduct Regular Tabletop Exercises</li>
        <li>8. Tabletop exercises for incident response should involve decision-makers and leaders from within the company. A well-structured tabletop involves clearly defined goals and prearranged scenarios to which participants must respond. Tabletop cybersecurity exercises work best when they start with a scenario (like malware), then move through a succession of scenes where participants are required to respond to fresh information added to the situation. The ambiguity and progression of actual situations are replicated in this structure. Tabletop exercises should imitate the difficult questions that participants would have to answer in a real attack.</li>
        <li>9. Report and know your government partners</li>
        <li>10. From Jen Easterly, head of CISA (Cybersecurity and Infrastructure Security Agency): Know your local CISA and FBI contacts and regional offices.</li>
        <li>11. They can help speed up the incident response process and help use this data to prevent similar attacks for other critical infrastructure organizations.</li>
        <li>12. <u>Find Regional CISA Office</u></li>
        <li>13. <u>Find Regional FBI Office</u></li>
        </ol>
